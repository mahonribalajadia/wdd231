...
const wddLink = document.getElementById("wddLink");
const cseLink = document.getElementById("cseLink");
const links = [allLink, wddLink, cseLink];

function setActiveLink(filterName) {
    links.forEach(link => link.classList.remove("active-course"));

    switch (filterName) {
        case "WDD":
            wddLink.classList.add("active-course");
            break;
        case "CSE":
            cseLink.classList.add("active-course");
            break;
        default:
            allLink.classList.add("active-course");
    }
}
...
function applySavedFilter() {
    ...
    if (savedFilter === "ALL") {
        ...
        const filtered = courses.filter(course => course.subject === savedFilter);
